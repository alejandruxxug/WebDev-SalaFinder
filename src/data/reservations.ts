/**
 * reservations.ts - Seed data for reservations
 *
 * Used when localStorage is empty. Links reservations to spaces and users by ID.
 * spaceName() looks up the space name for display.
 */
